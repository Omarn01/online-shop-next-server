  ...
  data: [
    {
      ...
      instructionsAndFiles: [
        {
          id: 1,
          title: 'Декларация: мобильные телефоны (смартфоны)',
          url: 'https://pub.fsa.gov.ru/rds/declaration/view/16546811/common',
        },
      ],
      discussions: [1],
      breadcrumbs: [
...
export const discussions = [
  {
    ...
    name: 'Пришелец-UV92055',
    date: '2 года назад',
    text: 'Вчера была ещё 12, сегодня уже 14.5 вы куда разогнались, старый привоз вы продаёте по неадекватным ценам',
    views: 355,
    comments: 4,
  },
]
